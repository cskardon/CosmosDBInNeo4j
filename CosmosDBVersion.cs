namespace CosmosDBExampleInNeo4j
{
    ...
    public class CosmosDBVersion
    {
        ...
        private static readonly string hostname = "Your Server";
        private static readonly int port = 443;
        private static readonly string authKey = "Your Key";
        ...
        {
            {"Cleanup", "g.V().drop()"}, //MATCH (n) DELETE n
            {"AddVertex 1", "g.addV('person').property('id', 'thomas').property('firstName', 'Thomas').property('age', 44)"}, //CREATE (:Person {id: 'thomas', firstName: 'Thomas', age: 44})
        ...
        {
            var gremlinServer = new GremlinServer(hostname, port, true,
            ...
            using (var gremlinClient = new GremlinClient(gremlinServer, new GraphSON2Reader(), new GraphSON2Writer(), GremlinClient.GraphSON2MimeType))
            {
                ...
                {
                    Console.WriteLine("Running this query: {0}: {1}", query.Key, query.Value);
